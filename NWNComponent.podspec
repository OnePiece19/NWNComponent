#
# Be sure to run `pod lib lint NWNComponent.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  s.name             = 'NWNComponent'
  s.version          = '0.1.0'
  s.summary          = 'A short description of NWNComponent.'
...
TODO: Add long description of the pod here.
  ...
  s.source_files = 'NWNComponent/Classes/**/*'
  
  # s.resource_bundles = {
  #   'NWNComponent' => ['NWNComponent/Assets/*.png']
  # }
